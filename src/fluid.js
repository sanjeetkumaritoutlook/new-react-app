...
export const fluid = {
  environments: {
    ...
    external: {
      label: 'External',
      esm: 'https://fluid-components.libertymutual.com/fluid/build/fluid.esm.js',
      legacy: 'https://fluid-components.libertymutual.com/fluid/build/fluid.js',
      css: 'https://fluid-components.libertymutual.com/fluid/build/fluid.css',
    },
  },
  init: (fluid, opts) => {
    console.debug(
